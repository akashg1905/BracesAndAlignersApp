...
class TimerForegroundService : Service() {
    ...
    override fun onStartCommand(intent: Intent?, flags: Int, startId: Int): Int {
        ...
        startForeground(NOTIFICATION_ID, createNotification("Timer Active", "Monitoring non-wear time", System.currentTimeMillis()))
        ...
        serviceScope.launch {
            try {
                ...
                if (state.isRunning && state.activeSessionStart != null) {
                    ...
                    val notification = createNotification("Timer Active", content, state.activeSessionStart)
    ...
    private fun createNotification(title: String, content: String, startTimeMillis: Long? = null): Notification {
        ...
        val builder = NotificationCompat.Builder(this, NotificationHelper.CHANNEL_SERVICE)
            ...
            .setPriority(NotificationCompat.PRIORITY_DEFAULT) // Using default for better visibility on budget devices
    ...
    override fun onDestroy() {
        Log.i(TAG, "Service destroyed, removing notification")
        // Remove from foreground and clear notification immediately
