...
import com.example.bracesaligner.di.DatabaseModule;
import com.example.bracesaligner.di.NetworkModule;
import com.example.bracesaligner.di.PreferencesModule;
...
import com.example.bracesaligner.feature.notifications.TimerCheckWorker_HiltModule;
...
public final class BracesApp_HiltComponents {
  private BracesApp_HiltComponents() {
  }
  ...
  @Component(
      modules = {
          ...
          TimerCheckWorker_HiltModule.class
      }
  )
  @Singleton
  public abstract static class SingletonC implements BracesApp_GeneratedInjector,
